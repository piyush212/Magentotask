...
namespace Codilar\AbandonedCarts\Block\Adminhtml\Shopcart\Abandoned;;
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'items',
                'renderer' => \Codilar\AbandonedCarts\Block\Adminhtml\Grid\Column\Renderer\Items::class,
            ]
        );
        ...
        $this->addColumn(
            'sku',
            [
                'header' => __('Products SKU'),
                'index' => 'sku',
                'renderer' => \Codilar\AbandonedCarts\Block\Adminhtml\Grid\Column\Renderer\Sku::class,
            ]
        );
